...
* The original package name 'com.example.Java-First-Rest-Api-Spring-Application' is invalid and this project uses 'com.example.Java_First_Rest_Api_Spring_Application' instead.
